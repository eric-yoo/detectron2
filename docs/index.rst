...
.. meta::
   :title: Detectron2
   :description: Detectron2 공식 문서 한글 번역
   :keywords: detectron2, 디텍트론2, detectron, 디텍트론, translation, 번역, Korean, 한글, PyTorch, 파이토치, documentation, docs, 독스, 문서, guide, 가이드, 사용법, 설명서
